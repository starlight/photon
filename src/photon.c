/* Generated from core/photon.scm by the CHICKEN compiler
   ...
   command line: core/photon.scm -output-file photon.c -static -uses parse -emit-link-file photon.link
   uses: eval-modules eval parse library
*/
#include "chicken.h"
...
C_trace(C_text("core/photon.scm:7: scheme#display"));
...
C_trace(C_text("core/photon.scm:8: scheme#newline"));
...
C_trace(C_text("core/photon.scm:9: photon.parse#photon-parse"));
...
/* a166 in k145 in k142 in k139 in k136 */
...
lf[3]=C_h_intern(&lf[3],14, C_text("scheme#newline"));
lf[4]=C_h_intern(&lf[4],14, C_text("scheme#display"));
lf[5]=C_decode_literal(C_heaptop,C_text("\376B\000\000\021photon v0.0.1-rc1"));
lf[6]=C_h_intern(&lf[6],30, C_text("##sys#register-compiled-module"));
lf[7]=C_h_intern(&lf[7],6, C_text("photon"));
lf[8]=C_h_intern(&lf[8],22, C_text("##sys#with-environment"));
