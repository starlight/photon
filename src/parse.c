...
t4=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_171,a[2]=((C_word*)t0)[2],tmp=(C_word)a,a+=3,tmp);{
C_word *av2=av;
av2[0]=C_SCHEME_UNDEFINED;
av2[1]=t4;
C_comparse_toplevel(2,av2);}}

/* k169 in k166 in k163 */
...
a=C_alloc(3);
t2=C_mutate((C_word*)lf[2]+1 /* (set! photon.parse#photon-parse ...) */,(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_173,a[2]=((C_word)li0),tmp=(C_word)a,a+=3,tmp));
t3=((C_word*)t0)[2];{
C_word *av2=av;
av2[0]=t3;
...
/* photon.parse#photon-parse in k169 in k166 in k163 */
...
C_trace(C_text("core/parse.scm:10: scheme#display"));
...
t2=(*a=C_CLOSURE_TYPE|2,a[1]=(C_word)f_165,a[2]=t1,tmp=(C_word)a,a+=3,tmp);{
C_word *av2=av;
av2[0]=C_SCHEME_UNDEFINED;
av2[1]=t2;
...
{C_text("f_165:core_2fparse_2escm"),(void*)f_165},
{C_text("f_168:core_2fparse_2escm"),(void*)f_168},
{C_text("f_171:core_2fparse_2escm"),(void*)f_171},
{C_text("f_173:core_2fparse_2escm"),(void*)f_173},
